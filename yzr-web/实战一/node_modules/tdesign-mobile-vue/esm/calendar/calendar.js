...
import { defineComponent, ref, computed, toRaw, watch, resolveComponent, openBlock, createElementBlock, createVNode, withCtx, createElementVNode, normalizeClass, renderSlot, createTextVNode, toDisplayString, unref, Fragment, renderList, normalizeStyle, createCommentVNode, createBlock, mergeProps } from 'vue';
...
var script = /* @__PURE__ */defineComponent(_objectSpread(_objectSpread({}, __default__), {}, {
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      return openBlock(), createElementBlock("div", null, [createVNode(_component_t_popup, {
        ...
        default: withCtx(function () {
          return [createElementVNode("div", {
            ...
            return [unref(confirmBtn) ? (openBlock(), createBlock(_component_t_button, mergeProps({
              key: 0,
              block: "",
              theme: "primary"
            }, unref(confirmBtn), {
