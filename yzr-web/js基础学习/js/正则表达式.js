// 正则表达式的创建方式
// 1，new RegExp(表达式，匹配模式（i,g）)
// 2，/表达式/匹配模式

// let reg = new RegExp("","");灵活
// let reg = // 简单
...
//作用2：进行模式匹配
// let reg = /^[0-9A-z]*@[A-Za-z0-9]+((.|-)[A-Za-z0-9]+)*.[A-Za-z0-9]+$/
// let str = "yzr674956@126.com"
// console.log(reg.test(str))
...
// split 方法将字符串转为数组
// let str = "1a2b3c4d5g7h"
// // 配合正则表达式
// let arr = str.split(/[a-z]/)
// arr.pop()
// console.log(arr)

// search 搜索字符串中含有内容 返回索引
// 配合正则表达是
// let str = "hello aec world abc"
// // let result = str.search('abc')
// let result = str.search(/a[bef]c/)
// console.log(result)

// match 找到一个或多个内容并提取 默认只会返回第一个内容 设置正则表达式为全局表达式
// let str = "hello aec world abc ABC"
// // let result = str.search('abc')
// let result = str.match(/a[bef]c/ig)
// console.log(result)

// replace  两个参数 后一个参数替换前一个 默认只替换第一个
let str = "hello aec world abc ABC"
// let result = str.search('abc')
let result = str.replace(/a[bef]c/ig,"ABCD")
console.log(result)
